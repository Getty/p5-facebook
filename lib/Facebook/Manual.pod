# PODNAME: Facebook::Manual
# ABSTRACT: All you need to know about, and developing applications for, Facebook.
...
=head1 THIS NAMESPACE

=head2 L<Facebook::Manual>

L<Facebook::Manual> will try to gather all informations you could need for developing Facebook applications and services.

=head2 L<Facebook::Cookbook>

L<Facebook::Cookbook> is a resource for example source code which is explained in detail.

=head2 L<Facebook::App>

L<Facebook::App> = Facebook Desktop Applications

=head2 L<Facebook::Web>

L<Facebook::Web> = Facebook Web Applications
...
=head2 Facebook JavaScript (FBJS)

L<Facebook documentation about FBJS|http://developers.facebook.com/docs/fbjs>
...
Automatically compose uri_for URIs in your Facebook application. Its bound to be used in combination with L<Catalyst::Plugin::Facebook>
and sadly cant be used in combination with the L<Facebook> distribution.
